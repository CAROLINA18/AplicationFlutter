...
import 'package:flutterapp/pages/AddStory.dart';
import 'package:flutterapp/pages/FormUser.dart';
import 'package:flutterapp/pages/Stories.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  goAddStoryPage(User user,{bool hasStory=false}){
    Navigator.push(context, MaterialPageRoute(builder: (_)=>
    (hasStory)?Stories(user):AddStory(user)));
  }
